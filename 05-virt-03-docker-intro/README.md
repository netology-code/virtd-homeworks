...
# Домашнее задание к занятию 3. «Введение в docker и docker compose»
...
Практические задачи выполняется на личной рабочей станции или созданной вами ранее ВМ в облаке.
## Задача 1
...
10. Проверьте вывод команд: ```ss -tlpn | grep 127.0.0.1:8080``` , ```docker port custom-nginx-t2```, ```curl http://127.0.0.1:8080```. Кратко объясните суть ошибки.
...
8. Удалите файл docker-compose.yaml.  Выполните команду "docker-compose up -d". Прочитайте warning и выполните предложенное действие. Погасите тестовый стенд.
