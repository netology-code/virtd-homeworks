...
2. Задания со звёздочкой необязательные к выполнению, их решение никак не повлияет на получение зачета по домашнему заданию.
...
## Задача 3
1. Запустите в yandex cloud ВМ согласно инструкций(вам хватит 2 Гб Ram).
